...
import { ModelMetadataDetails } from "./model-metadata-details";
...
export function ImgGenSettings({
    ...
    const usesSingleSubmissionAttempt =
        usesSingleImageSubmissionAttempt(provider, model);
        ...
        <Card className="h-fit glass-card border-0">
            ...
            <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <ModelPicker value={model} onChange={setModel} models={modelSuggestions} scope={`${provider}:${mode}`} />
                    ...
                    <ModelMetadataDetails model={selectedModel} />
