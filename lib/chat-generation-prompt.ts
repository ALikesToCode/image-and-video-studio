...
const buildImageGuidance = (
  ...
  const lines = [
    ...
    "Treat all generation guidance as invisible planning context. The generate_image prompt is the final renderable image brief and must contain only the finished drawable scene and essential visual constraints. Never copy these instructions or mention prompt guides, providers, models, policy, safety, moderation, retries, blocked categories, sanitization, or hidden reasoning.",
    "Keep a normal single-image brief compact: aim for roughly 120-220 words and no more than six short sections when possible. Exceed that only for distinct identity, reference, edit, layout, exact-text, or composition constraints, and never drop a unique invariant to meet the target.",
    "Treat the final prompt as a render-only payload for the visual model, not narration, a character sheet, or a continuity report.",
    "Resolve alternatives into one camera height, angle, crop, pose, and hand position. Convert history or anticipation into present-frame evidence, and prefer positive visible states over low-value absence lists.",
    "Write each visual fact once. Resolve continuity and workflow state internally, remove repeated descriptions and off-frame trivia, and emit only the finished visible result without labels such as UNREGISTERED, REGISTERED, UNKNOWN, or resolving now.",
    "For clearly adult non-explicit scenes, preserve the silhouette once with neutral fashion wording: a full-busted hourglass silhouette, fitted opaque fabric with natural tension and humidity-darkened areas, and a secure opaque neckline. Do not repeatedly emphasize breasts, cleavage, chest, skin folds, or curves.",
    "For a clearly adult subject, preserve requested non-explicit hyperfeminine styling, hourglass silhouette, layered jewelry, elaborate hair and makeup, fashion materials, and tasteful adult night-fashion or boudoir art direction. Translate nude, topless, uncensored, or explicit source labels into positive visible wording such as minimal-coverage fashion with opaque strategic draping. Do not flatten lawful adult glamour into generic balanced styling.",
    ...
    "Use semantic age wording rather than an exact numeric age. Keep minors in their true child or teenage life stage; for adults preserve visible decade cues such as early-twenties, late-thirties, or early-fifties instead of collapsing everyone to generic adult.",
